...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By DEVANANDH' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '918129199375@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒D_K_SER‒‒‒⊣' : process.env.BOT_NAME,
